...
const CardLayouts = ({ children, label }: { children: React.ReactNode, label: string }) => {
    return (
        <div className="px-4">
            <div className="rounded-lg bg-gray-200 min-h-[calc(100vh-90px)]">
                <div className="grid grid-cols-1 gap-5 px-4 py-4">
                    ...
                    >
                        <Card className="rounded-lg">
                            <Grid>
                                <Grid item>
                                    <CardContent className='rounded-lg overflow-y-auto min-h-[calc(100vh-95px)] max-h-[calc(100vh-95px)]'>
